...
export const PERMISSION_GROUPS: readonly PermissionGroup[] = [
  ...
  'Betrieb',
  'Finanzen',
  // Nach den Finanzen, weil die Reihenfolge die Reihenfolge in der
  // Rechtematrix ist — Strategie, Budget und Risiko gehören neben die Zahlen.
  'Unternehmensführung',
  'Personal',
  'Kommunikation',
  'System',
...
export const PERMISSION_META: Record<Permission, PermissionMeta> = {
  ...
  'objective:read_own': { label: 'Objectives.ViewOwn', group: 'Unternehmensführung', description: 'Die eigenen Ziele und die freigegebenen Firmenziele einsehen.', scoped: true },
  'objective:create': { label: 'Objectives.Create', group: 'Unternehmensführung', description: 'Strategien, Ziele und Initiativen anlegen.' },
  'objective:update': { label: 'Objectives.Edit', group: 'Unternehmensführung', description: 'Ziele bearbeiten, umhängen und ihren Status ändern.' },
  ...
  'budget:update': { label: 'Budget.Edit', group: 'Unternehmensführung', description: 'Budgetzeilen ändern und Nachträge erfassen.' },
  ...
  'investment:update': { label: 'Investments.Edit', group: 'Unternehmensführung', description: 'Investitionen ändern, in Betrieb nehmen oder ausbuchen.' },
  ...
  'risk:update': { label: 'Risks.Edit', group: 'Unternehmensführung', description: 'Risiken bewerten, Massnahmen hinterlegen und Prüfungen abschliessen.' },
  ...
  'control:update': { label: 'Controls.Edit', group: 'Unternehmensführung', description: 'Kontrollen ändern und ihre Prüfung abschliessen.' },
  ...
  'action:update': { label: 'Actions.Edit', group: 'Unternehmensführung', description: 'Massnahmen bearbeiten und ihre Wirksamkeit bestätigen.' },
  ...
  'document:read_own': { label: 'Documents.ViewOwn', group: 'Unternehmensführung', description: 'Die eigenen Personaldokumente öffnen.', scoped: true },
  ...
  'document:update': { label: 'Documents.Edit', group: 'Unternehmensführung', description: 'Angaben, Fristen und Sichtbarkeit eines Dokuments ändern.' },
  ...
  'knowledge:update': { label: 'Knowledge.Edit', group: 'Unternehmensführung', description: 'Wissensartikel bearbeiten und veröffentlichen.' },
  ...
  'meeting:update': { label: 'Meetings.Edit', group: 'Unternehmensführung', description: 'Protokolle, Beschlüsse und Pendenzen bearbeiten.' },
  ...
  'data:purge': { label: 'Data.Purge', group: 'System', description: 'Ganze Datenbereiche endgültig löschen — jeder Lauf steht im Prüfprotokoll.' },
